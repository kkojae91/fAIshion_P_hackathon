...
def save_csv(result):
    ...
    # print(result)
    result.to_csv("C:/Users/kojaejeung/Desktop/프로젝트/해커톤프로젝트/book_data/algorithm_data.csv", header=False, index=False, encoding="cp949")
...
def main():
    ...
    # 검색어 알고리즘
    driver.get("http://www.yes24.com/searchcorner/Search?keywordAd=&keyword=&domain=ALL&qdomain=%C0%FC%C3%BC&query=%BE%CB%B0%ED%B8%AE%C1%F2")
